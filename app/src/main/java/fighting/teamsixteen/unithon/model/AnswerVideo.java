...
public class AnswerVideo {
    ...
    public Date getCurrentDate(){ return curentDate; }
    ...
    private void setCurrrentDate(Date currrentDate) {this.curentDate = currrentDate;}
    ...
    public void setData(int idx, Date currentDate, int questionIdx, String filePath, int credit, String sumnailPath){
        setIdx(idx);
